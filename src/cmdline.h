...
struct gengetopt_args_info
{
  ...
  int touch_flag;	/**< @brief Invert user-precense flag (on by default) (default=off).  */
  const char *touch_help; /**< @brief Invert user-precense flag (on by default) help description.  */
